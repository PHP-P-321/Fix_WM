...
--
-- Хост: 127.0.0.1
-- Время создания: Май 13 2024 г., 12:16
...
INSERT INTO `requests` (`id`, `id_master`, `id_client`, `company_name`, `model_name`, `type_of_fault`, `status`, `price`) VALUES
(2, '1', 3, 'Привет', 'Модель 1', 'Тип 1', 4, 3500),
(3, '2', 3, 'Привет 1', 'Модель 2', 'Тип 2', 4, 5000),
(5, '1', 3, 'Привет 2', 'Модель 3', 'Описание проблемы 3', 4, 1000);
